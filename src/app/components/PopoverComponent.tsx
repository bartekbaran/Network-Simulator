...
function PopoverComponent({
  ...
  return (
    <>
      {showPopover && <div className="absolute right-5 top-16 w-full max-w-sm px-4">
        <Popover className="relative">
          {({open}) => (
            <>
              ...
              >
                <Popover.Panel
                  className="absolute z-10 mt-3 w-full right-1/3 max-w-sm transform px-4 sm:px-0 lg:max-w-3xl">
                    ...
                    <div className="relative grid gap-8 bg-white p-7 lg:grid-cols-1">
                      {flows.map((flow) => (
                        ...
                        >
                          ...
                          >
                            <PencilIcon
                              className="text-black bg-gray-100 rounded-md p-1 border-solid border-2 border-gray-200"/>
                          </button>
                          <div className="ml-4">
